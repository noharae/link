        ...
        return {
            ...
            bookMarkGroups: {
                ...
                otherLinks: Object.freeze([
                    ...
                    {name: 'Cloudflare', label: 'Cloudflare', url: 'https://dash.cloudflare.com/'},
                    ...
                    {name: 'Smms', label: 'S.EE', url: 'https://s.ee/zh-CN/'},
...
//                    {name: 'noharae', label: '野原', url: 'https://noharae.eu.org/'},
            ...
            leftBookMarkGroups: {
                ...
                cloudDiskLinks: Object.freeze([
                    ...
                    {mark: false, label: '萌盘', url: 'https://pan.moe/home'},
                ]),
                fileLinks: Object.freeze([
                    ...
                    {mark: true, label: 'docsmall', url: 'https://docsmall.com/'},
                    ...
                    {mark: false, label: 'PairDrop 文件传输', url: 'https://pairdrop.net/'},
                ]),
                ...
                audioLinks: Object.freeze([
                    ...
                    {mark: false, label: 'AudioMass 音频编辑', url: 'https://audiomass.co/'},
                ...
                pictureLinks: Object.freeze([
                    ...
                    {mark: true, label: 'Photopea', url: 'https://www.photopea.com/'},
                    ...
                    {mark: true, label: 'waifu2x', url: 'https://waifu2x.udp.jp/index.zh-CN.html'},
                    {mark: false, label: 'Bigjpg', url: 'https://bigjpg.com/'},
                    {mark: false, label: '瀑布流图片', url: 'https://wlm3201.github.io/Masonry_Image_Viewer/'},
                    {mark: false, label: 'ComicRead PWA', url: 'https://comic-read.pages.dev/'},
                    {mark: true, label: 'S.EE', url: 'https://s.ee/zh-CN/'},
                    {mark: false, label: '流浪图床', url: 'https://p.sda1.dev/'},
                    {mark: false, label: '路过图床', url: 'https://imgchr.com/'},
                    {mark: false, label: 'Snipboard', url: 'https://snipboard.io/'},
                ...
                bookLinks: Object.freeze([
                    ...
                    {mark: false, label: '鲁迅图书馆', url: 'https://luxunlib.com/'},
                ]),
                developLinks: Object.freeze([
                    {mark: true, label: 'GitHub', url: 'https://github.com/'},
                    {mark: true, label: 'Vercel', url: 'https://vercel.com/'},
                    {mark: false, label: 'Netlify', url: 'https://app.netlify.com/'},
                    {mark: false, label: 'Supabase', url: 'https://supabase.com/'},
                    {mark: true, label: 'Cloudflare', url: 'https://dash.cloudflare.com/'},
                ...
                otherLinks: Object.freeze([
                    ...
                    {mark: false, label: 'Literature Clock', url: 'https://literature-clock.jenevoldsen.com/'},
            ...
            rightBookMarkGroups: {
                ...
                gameLinks: Object.freeze([
                    ...
                    {mark: false, label: 'Nintendo', url: 'https://www.nintendo.com/'},
                ...
                onlineGameLinks: Object.freeze([
                    ...
                    {mark: false, label: '小霸王 在线游戏', url: 'https://www.yikm.net/'},
                    {mark: false, label: 'Poki 在线游戏', url: 'https://poki.com/zh'},
                ...
                softwareLinks: Object.freeze([
                    ...
                    {mark: false, label: 'uwp 应用下载', url: 'https://store.rg-adguard.net/'},
                ...
                otherLinks: Object.freeze([
                    ...
                    {mark: false, label: 'UNBLOCKIT', url: 'https://unblockit.pages.dev/'},
                ]),
            },
