...
//                    {id: 416, name: 'noharae', label: '野原', url: 'https://noharae.eu.org/'},
            ...
            rightBookMarkGroups: {
                ...
                wikiLinks: [
                    {id: 1701, mark: false, label: '空洞骑士 Wiki', url: 'https://hkss.huijiwiki.com/wiki/%E9%A6%96%E9%A1%B5'},
                    {id: 1702, mark: false, label: '饥荒 Wiki', url: 'https://dontstarve.huijiwiki.com/wiki/%E9%A6%96%E9%A1%B5'},
                    {id: 1703, mark: false, label: '泰拉瑞亚 Wiki', url: 'https://terraria.wiki.gg/zh/'}, 
                    {id: 1703, mark: false, label: '誠也の部屋', url: 'https://seiya-saiga.com/'}, 
                    {id: 1703, mark: false, label: 'Speedrun', url: 'https://www.speedrun.com/zh-CN'}, 
                ],
                musicLinks: [
                ...
                pmLinks: [
                    ...
                    {id: 1302, mark: false, label: '朱／紫 数据库', url: 'https://sv.xzonn.top/wiki/宝可梦一览'},
                    {id: 1303, mark: false, label: 'Bulbapedia', url: 'http://bulbapedia.bulbagarden.net/wiki/Main_Page'},
                    {id: 1304, mark: false, label: 'Serebii.net', url: 'https://www.serebii.net/index2.shtml'},
                    {id: 1305, mark: false, label: 'ポケモンWiki', url: 'https://wiki.xn--rckteqa2e.com/wiki/メインページ'},
                    {id: 1306, mark: false, label: 'PTCGP Tracker', url: 'https://ptcgp-tracker.com/'},
